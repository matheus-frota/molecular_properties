IMAGE = predict_molec_prop
PACKAGE = predict_molec_prop
...
help:
	...
	@echo "    PARAMS             Parameters to pass as: $ predict_molec_prop <command> $(PARAMS)."
...
clean: clean-dist
	rm -rf predict_molec_prop.egg_info
