...
| -----                | ----------------       | -----------              | ---------    |
| Data Scientist       | Author                 | [`Matheus Frota`]            | [`matheusfrota@hotmail.com.br`] |
...
```
git clone https://github.com/<@github_username>/predict_molec_prop.git
cd predict_molec_prop
```
...
* [predict_molec_prop](./predict_molec_prop/): main Python package with source of the model.
